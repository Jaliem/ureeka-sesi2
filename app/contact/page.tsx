      ...
      <section className="py-20">
        <div className="container px-4 mx-auto">
          ...
          <div className="flex flex-col items-center mb-12 text-center">
            <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">Contact Information</h1>
          ...
          {/* Contact Information */}
          <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg dark:bg-zinc-800">
            ...
            <div className="mt-8">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-zinc-600 dark:text-zinc-400">Monday - Sunday</span>
